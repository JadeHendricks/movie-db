...
const Pagination = ({ pages, nextPage, currentPage, query }) => {

  return (
    <div className="pagination">
      <div className="pagination__prev">
      { currentPage > 1 ? <button className="button button--white" onClick={() => nextPage(currentPage - 1, query)} >
      ...
      { currentPage < pages + 1 ? <div className="pagination__next">
        <button className="button button--white" onClick={() => nextPage(currentPage + 1, query)}> 
